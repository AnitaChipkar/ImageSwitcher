...
import com.anitac.imageswitcher.databinding.GalleryViewpagerBinding
...
class GalleryPagerActivity : AppCompatActivity() {
    ...
    companion object {
        fun getStartIntent(mContext: Context, mediaList: ArrayList<String>, position: Int): Intent {
            ...
            intent.putStringArrayListExtra(IConstants.SELECTED_IMAGE, mediaList)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val values = intent?.getStringArrayListExtra(IConstants.SELECTED_IMAGE)
